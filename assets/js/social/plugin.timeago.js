  ...
  $.extend($.timeago, {
    settings: {
      ...
      strings: {
        prefixAgo: null,
        prefixFromNow: null,
        suffixAgo: translate['ago'],
        suffixFromNow: translate["from now"],
        seconds: translate['less than a minute'],
        minute: translate["about a minute"],
        minutes: "%d "+translate['minutes'],
        hour: translate['about']+" "+translate['an hour'],
        hours: translate['about']+" %d "+translate['hours'],
        day: translate["a day"],
        days: "%d "+translate['days'],
        month: translate["about a month"],
        months: "%d "+translate["months"],
        year: translate["about a year"],
        years: "%d "+translate["years"],
        numbers: []
      }
    },
